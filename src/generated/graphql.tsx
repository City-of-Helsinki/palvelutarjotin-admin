    ...
    & { response?: Maybe<(
      ...
      & { body?: Maybe<(
        ...
        & { name: (
          ...
          { __typename?: 'PalvelutarjotinEventNode' }
          & Pick<PalvelutarjotinEventNode, 'id' | 'neededOccurrences'>
        ), infoUrl?: Maybe<(
          { __typename?: 'LocalisedObject' }
          & Pick<LocalisedObject, 'en' | 'fi' | 'sv'>
        )> }
...
export type PEventFieldsFragment = (
  { __typename?: 'PalvelutarjotinEventNode' }
  & Pick<PalvelutarjotinEventNode, 'id' | 'nextOccurrenceDatetime' | 'autoAcceptance' | 'contactEmail' | 'contactPhoneNumber' | 'enrolmentEndDays' | 'enrolmentStart' | 'neededOccurrences'>
  & { contactPerson?: Maybe<(
    { __typename?: 'PersonNode' }
    & PersonFieldsFragment
  )>, organisation?: Maybe<(
...
export type OccurrenceFieldsFragment = (
  { __typename?: 'OccurrenceNode' }
  & Pick<OccurrenceNode, 'id' | 'amountOfSeats' | 'minGroupSize' | 'maxGroupSize' | 'seatsTaken' | 'seatsApproved' | 'remainingSeats' | 'startTime' | 'endTime' | 'placeId' | 'cancelled'>
  & { pEvent?: Maybe<(
    { __typename?: 'PalvelutarjotinEventNode' }
    & Pick<PalvelutarjotinEventNode, 'id'>
  )>, languages: Array<(
...
export type VenueFieldsFragment = (
  { __typename?: 'VenueNode' }
  & Pick<VenueNode, 'id' | 'hasClothingStorage' | 'hasSnackEatingPlace' | 'outdoorActivity'>
  & { translations: Array<(
    { __typename?: 'VenueTranslationType' }
