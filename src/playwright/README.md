...
- Run `pnpm test:browser:install` to install the [browsers](https://playwright.dev/docs/browsers)
...
| Playwright                      | API                                                         | Admin UI build (i.e. `pnpm build`)       |
|---------------------------------|-------------------------------------------------------------|------------------------------------------|
...
2. Set up `.env` file so that you can build the UI with `pnpm build` and it connects and authenticates to the API
...
- Run all tests non-interactively in parallel: `pnpm test:browser:ci`
  - Useful for fast testing locally
- Run all tests non-interactively & sequentially: `pnpm test:browser:ci -j1`
...
- Autogenerate tests with [codegen](https://playwright.dev/docs/codegen): `pnpm codegen:browser <User interface URL>`
- Show last report generated by Playwright tests: `pnpm test:browser:report`
