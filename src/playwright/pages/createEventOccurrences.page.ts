...
export class CreateEventOccurrencesPage extends AuthenticatedPage {
  ...
  protected occurrenceLocationDropdown: Locator;
  ...
  constructor(page: Page) {
    ...
    this.occurrenceLocationDropdown = this.page.getByTestId(
      'occurrences-form-event-location'
    );
  ...
  get selectedOccurrenceLocation(): Locator {
    return this.locateSelectedValueForAutoSuggestTextBox(
      this.occurrenceLocationTextBox
    );
  }
