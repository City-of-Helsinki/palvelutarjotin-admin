...
export class AuthenticatedPage extends BasePage {
  ...
  locateSelectedValueForAutoSuggestTextBox(
    autoSuggestTextBox: Locator
  ): Locator {
    // NOTE: This is a bit brittle, as this relies on the structure of the HTML,
    // but looking at the HTML content there didn't seem to be any Playwright
    // best practice way to do this:
    return autoSuggestTextBox.locator('+ div'); // next sibling <div>
  }
