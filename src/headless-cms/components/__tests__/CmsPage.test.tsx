        ...
        children: [
          {
            ...
            uri: '/paasivu/alisivu2/oppimateriaali1/',
          },
          {
            title: 'Oppimateriaali2',
            uri: '/paasivu/alisivu2/oppimateriaali2/',
          },
          {
            title: 'Oppimateriaali3',
            uri: '/paasivu/alisivu2/oppimateriaali3/',
          },
          {
            title: 'Oppimateriaali4',
            uri: '/paasivu/alisivu2/oppimateriaali4/',
          },
          {
            title: 'Oppimateriaali5',
            uri: '/paasivu/alisivu2/oppimateriaali5/',
          },
          {
            title: 'Oppimateriaali6',
            uri: '/paasivu/alisivu2/oppimateriaali6/',
          },
        ],
      },
      {
...
test('renders CMS page and navigation flow works', async () => {
  ...
  const breadcrumbs2 = getBreadcrumbsContainer();
  breadcrumbs2.getByRole('link', { name: /kotisivu/i });
  breadcrumbs2.getByRole('link', { name: /pääsivu/i });
  breadcrumbs2.getByText('Alisivu1');
  ...
  const secondNavigationChild = screen.getByRole('link', {
  ...
  const thirdNavigationChild = screen.getByRole('link', {
...
it.todo('CMS sub pages can be searched');
